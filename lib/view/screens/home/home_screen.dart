...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Get.find<ProductController>().getPopularProductList(false);
    Get.find<RestaurantController>().getLatestRestaurantList(false);
    Get.find<ProductController>().getReviewedProductList(false);
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: RefreshIndicator(
          ...
          child: ResponsiveHelper.isDesktop(context) ? WebHomeScreen(scrollController: _scrollController) : CustomScrollView(
